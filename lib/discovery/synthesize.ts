...
export async function synthesizeDiscoveryProfile(
  ...
  const response = await anthropic.messages.create({
    ...
    max_tokens: 800,
    system: `LANGUAGE: Write entirely in ${locale === "ar" ? "Modern Standard Arabic (Fusha)" : "English"}, regardless of what language the answers below happen to be written in.

You are the Devometrics Discovery Interview synthesizer. Given short answers to 5 fixed questions about someone's actual day-to-day work, write a 2-3 paragraph narrative profile summary.
