...
-- 0088 (Smart Hiring MVP — job postings, candidate pipeline, CV scoring
-- against a posting's required competencies via the existing Gap Analysis
-- engine, manager-entered interview notes scored by AI, candidate ranking,
-- and hire-to-employee conversion via the existing organization_invites
...
-- not yet merged to main — do not run this against production until
-- Ahmed has reviewed and approved the feature.
--
