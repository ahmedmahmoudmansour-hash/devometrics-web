...
-- EXISTS / a catalog-lookup DO block instead of a guessed constraint
-- name), so running this more than once, or after part of it already ran,
-- is safe. Order matters within this file (0077 alters tables 0076
-- creates; 0078 replaces functions 0076/0077 create; 0081 redefines the
-- organization_members insert policy 0079 last defined; 0084 is fully
-- independent of everything before it and safe to run standalone) — paste
-- and run the whole thing as one block.
--
-- NOTE: if 0076-0083 are already applied to your database (true for
-- production as of 2026-07-23), you only need to run the standalone
-- migrations/0084_knowledge_hub.sql file on its own — it doesn't touch
-- any table from 0076-0083.
--
